...
class Booking
{
    ...
    public function setBookingChannel(?string $booking_channel): self
    {
    ...
    public function getCustomBookingNo(): ?string
    {
        return $this->custom_booking_no;
    }

    public function setCustomBookingNo(?string $custom_booking_no): self
    {
    ...
    public function getBookingOrganisationId(): ?string
    {
        return $this->booking_organisation_id;
    }

    public function setBookingOrganisationId(?string $booking_organisation_id): self
    {
