...
class Train
{
    ...
    public function getTrainChannel(): ?string
    {
        return $this->booking_channel;
    }

    public function setTrainChannel(?string $booking_channel): self
    {
    ...
    public function getTrainStatus(): ?bool
    {
        return $this->booking_status;
    }

    public function setTrainStatus(?bool $booking_status): self
    {
    ...
    public function getCustomTrainNo(): ?string
    {
        return $this->custom_booking_no;
    }

    public function setCustomTrainNo(?string $custom_booking_no): self
    {
    ...
    public function setTrainDate(\DateTimeInterface $booking_date): self
    {
    ...
    public function getTrainOrganisationId(): ?string
    {
        return $this->booking_organisation_id;
    }

    public function setTrainOrganisationId(?string $booking_organisation_id): self
    {
