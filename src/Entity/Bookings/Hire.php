...
/**
 * @ORM\Entity(repositoryClass="App\Repository\HireRepository")
 */
class Hire
{
    /**
    ...
    public function getHireChannel(): ?string
    {
        return $this->booking_channel;
    }

    public function setHireChannel(?string $booking_channel): self
    {
    ...
    public function getHireStatus(): ?bool
    {
        return $this->booking_status;
    }

    public function setHireStatus(?bool $booking_status): self
    {
    ...
    public function getCustomHireNo(): ?string
    {
        return $this->custom_booking_no;
    }

    public function setCustomHireNo(?string $custom_booking_no): self
    {
    ...
    public function setHireDate(\DateTimeInterface $booking_date): self
    {
    ...
    public function getHireOrganisationId(): ?string
    {
        return $this->booking_organisation_id;
    }

    public function setHireOrganisationId(?string $booking_organisation_id): self
    {
