...
class Flight
{
    ...
    public function getFlightChannel(): ?string
    {
        return $this->booking_channel;
    }

    public function setFlightChannel(?string $booking_channel): self
    {
    ...
    public function setFlightStatus(?bool $booking_status): self
    {
    ...
    public function getCustomFlightNo(): ?string
    {
        return $this->custom_booking_no;
    }

    public function setCustomFlightNo(?string $custom_booking_no): self
    {
    ...
    public function setFlightDate(\DateTimeInterface $booking_date): self
    {
    ...
    public function getFlightOrganisationId(): ?string
    {
        return $this->booking_organisation_id;
    }

    public function setFlightOrganisationId(?string $booking_organisation_id): self
    {
