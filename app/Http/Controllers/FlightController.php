...
/**
 * @Route("flight_bookings", name="flight_bookings")
 */
class FlightController extends AbstractController
{
    ...
    public function getRepository($model = "Flight")
    {
        $model = "\App\Bookings\\" . ucfirst($model);
        return $this->entityManager->getRepository($model);
    }

    public function getColumns($table = "flight_bookings")
    {
    ...
    public function createBooking(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        foreach ($this->getcolumns() as $field) {
            ...
            try {
                if (in_array($field, ["created_at", "updated_at", "departure_time", "arrival_time", "flight_date"])) {
